# Buienradar Daily Forecact sensor integration
...
PLATFORM_SCHEMA = PLATFORM_SCHEMA.extend({
    vol.Required(CONF_LAT, default='51'): cv.string,
    vol.Required(CONF_LON, default='3'): cv.string,
...
class RainForecastSensor(Entity):
    ...
    @property
    def name(self):
        return 'Buienradar Daily Forecast'
